...
export default function LandingPage() {
  ...
  const handleUrlSubmit = () => {
    ...
    // Navigate directly. Public playlists work without login.
    // The download page will use the server-side API for public data.
          ...
          <div className={styles.heroContent}>
            ...
            {!isLoggedIn && (
              <div className={styles.loginCta}>
                <span className={styles.loginText}>Need private playlists?</span>
        ...
        <footer className={styles.footer}>
          <div className={styles.footerContent}>
            <p className={styles.footerText}>
              SpotDown uses Spotify&apos;s API for metadata only. Audio is sourced from YouTube.
              <br />
              Please ensure compliance with local copyright laws.
            </p>
            <p className={styles.footerCopy}>
              © {new Date().getFullYear()} SpotDown. Not affiliated with Spotify AB.
            </p>
          </div>
        </footer>
      </main>
