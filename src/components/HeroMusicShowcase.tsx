...
const TRENDING_PAKISTANI_HITS: TrendingTrack[] = [
  ...
  },
  {
    ...
    album: "Faasle",
    duration: "3:41",
    spotifyUrl: "https://open.spotify.com/track/0s76ExpXyMGVBlKLUr683e",
  ...
  },
  {
    ...
    album: "Bikhra",
    duration: "2:48",
    spotifyUrl: "https://open.spotify.com/track/0OdztoASgKBBNcAgtErk0X",
